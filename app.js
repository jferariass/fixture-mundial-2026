...
}; // Mapa de ID -> Código FIFA (ej. 1 -> MEX)
...
function cargarResultados() {
    ...
    // Consultar directamente la lista de partidos (URL_GAMES) ya que tenemos el mapa de equipos precargado estáticamente
